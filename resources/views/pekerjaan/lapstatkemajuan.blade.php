...
<div class="col-md-12 col-sm-12 col-xs-12">
	...
	<div class="x_panel" id="cetak">
		...
		<div class="x_title text-primary">
			<h2>Laporan Status Pekerjaan Tahun Anggaran {{session()->get('ta')}}</h2> 
			...
			<table class="table  jambo_table results">
				<thead>
					<tr>
						...
						<th width="50px">Deviasi</th>
						<th width="150px">Status Kemajuan</th>
					</tr>
				</thead>
				<tbody>
					@php ($no = 1)
					...
					<tr class="{{ $class }}">
						...
						<td class="text-center">{{ formatTanggal($pekerjaan['tgllaporan']) }}</td>
						...
						<td class="text-center">{{ $pekerjaan['statuskemajuan'] }}</td>
					</tr>
					@endforeach
				</tbody>
			</table>
