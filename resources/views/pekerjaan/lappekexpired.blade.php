...
@section('title')
	Data Status Pekerjaan Kontrak Telah Berakhir
@endsection
...
<div class="col-md-12 col-sm-12 col-xs-12">
	...
	<div class="x_panel" id="cetak">
		...
		<div class="x_title text-primary">
			<h2>Laporan Status Pekerjaan Kontrak Berakhir  Tahun Anggaran {{session()->get('ta')}}</h2> 
		...
		<div class="x_content" id="data">
			<table class="table  jambo_table results">
				...
				<tbody>
					@php ($no = 1)
					@foreach ($datapekerjaanexpired as $pekerjaan)
						@php ($class = "")
