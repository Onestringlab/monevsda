				...
				<tbody>
					...
					<tr class="{{ $class }}">
						...
						<td align="center">
							...
							<a href="{{asset('/')}}pekerjaan/{{ $pekerjaan->idpekerjaan }}/update/y" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> </a>
							<a href="{{asset('/')}}pekerjaan/{{ $pekerjaan->idpekerjaan }}/delete/y" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>
						</td>
					</tr>
					@endforeach
				</tbody>
