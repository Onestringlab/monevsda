...
<div class="col-md-12 col-sm-12 col-xs-12">
	...
	<div class="x_panel" id="cetak">
		...
		<div class="x_title text-primary">
			<h2>Laporan Pekerjaan dan Pelaksana Tahun Anggaran {{session()->get('ta')}}</h2>
			...
			<table class="table  jambo_table results">
				<thead>
					<tr>
						...
						<th>dpa</th>
						<th>norka</th> -->
						<th width="300px">Nama Pekerjaan</th>
						<!-- <th >No Kontrak</th> -->
				...
				<tbody>
					...
					<tr class="{{ $class }}">
						...
						<td width="200px">{{ $pekerjaan['konpengawas'] }}</td>
						<td width="200px">{{ $pekerjaan['konperencana'] }}</td>
						<td width="200px">
