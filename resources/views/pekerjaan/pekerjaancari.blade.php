	...
	<div class="x_panel" id="cetak">
		...
		<div>
			<div class="form-group" id="caridata">
				<form class="form-horizontal" action="{{ asset('/') }}pekerjaancari" method="get">
					<div class="col-xs-12 col-sm-12 col-md-12 tebal input-group" >
            <input type="text" class="form-control" name="pencarian" placeholder="Cari Disini..." value="{{ $pencarian }}">
...
function printdiv(idpekerjaan) {
    var mywindow = window.open("https://monevsda-kr.com/public/pekerjaandetailprint/"+idpekerjaan);
}
</script>
