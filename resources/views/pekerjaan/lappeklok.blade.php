...
<div class="col-md-12 col-sm-12 col-xs-12">
	...
	<div class="x_panel" id="cetak">
		...
		<div class="x_title text-primary">
			<h2>Laporan Lokasi Pekerjaan Tahun Anggaran {{session()->get('ta')}}</h2> 
			<div class="clearfix"></div>
		</div>
		<div id="caridata">
			<!-- <div class="form-group"> -->
				<form class="form-horizontal" action="{{ asset('/') }}lappeklok" method="get">
					<div class="col-xs-12 col-sm-12 col-md-12 tebal input-group" >
            <input type="text" class="search form-control" name="pencarian" placeholder="Cari Disini..." value="{{ $pencarian }}">
